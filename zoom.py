...
def configure_button_listeners():
    ...
    pin_17 = GPIO.input(23)
    pin_18 = GPIO.input(24)

    # GPIO.RISING
    # GPIO.FALLING
    # GPIO.BOTH
    GPIO.add_event_detect(23, GPIO.FALLING, callback=button_pressed_17, bouncetime=200)
    GPIO.add_event_detect(24, GPIO.FALLING, callback=button_pressed_18, bouncetime=200)
